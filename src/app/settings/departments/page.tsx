    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm text-[var(--muted)]">
          ...
          Escalation contacts are stored now for later overdue invoice reminders.
        </p>
      </div>
      ...
      >
        <div>
          <h3 className="font-semibold">Organization Escalation Contacts</h3>
          <p className="mt-1 text-sm text-[var(--muted)]">
            Titles are customizable and will be used when escalation emails are added.
          </p>
        </div>
