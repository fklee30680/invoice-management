  ...
  return (
    <main className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="flex flex-col gap-4 border-b border-[var(--line)] pb-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold tracking-normal">
              Department Notification Setup
            </h1>
            <p className="mt-2 max-w-3xl text-sm text-[var(--muted)]">
              Maintain the routing table and the email template used for department
              invoice notifications. PO uploads can create departments by name, but
              invoices only auto-send when the department has an email address here.
            </p>
          </div>
        ...
        >
          <div>
            <h2 className="text-base font-semibold">Department Email Template</h2>
